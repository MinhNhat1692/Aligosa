@Section = React.createClass
    getInitialState: ->
      ...
      ProcessMenu:
        type: 1, className: 'zmdi zmdi-account', active: false, name: "Tác vụ", code: 31
      #DoctorMenu:
    ...
    Trigger: (code) ->
      ...
      if code == 31
        ...
        @setState ProcessMenu:
          type: 1, className: 'zmdi zmdi-account', active: true, name: "Tác vụ", code: 31
      else
        @setState ProcessMenu:
          type: 1, className: 'zmdi zmdi-account', active: false, name: "Tác vụ", code: 31
#      if code == 60
      ...
      React.DOM.section id: 'main',
        React.DOM.aside
          ...
          React.DOM.ul className: 'main-menu',
            ...
            React.createElement MenuAside, submenu: @state.ProcessMenu, Trigger: @Trigger
