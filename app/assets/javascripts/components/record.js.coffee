...
@RecordGeneral = React.createClass
	...
	Customer: ->
		...
		if @props.selected
			React.DOM.tr className: "toggled",
				React.DOM.td null, @props.record.customer_name
				React.DOM.td null, @props.record.address
				React.DOM.td null, @props.record.pnumber
				React.DOM.td null, @props.record.noid
				React.DOM.td null, @state.typeName
	...
	Project: ->
		if @props.selected
			React.DOM.tr className: "toggled",
				React.DOM.td null, @props.record.project_name
				React.DOM.td null, @props.record.contractor
				React.DOM.td null, @props.record.basic_info
				React.DOM.td null, @props.record.address
		else
			React.DOM.tr onClick: @selectRecord,
				React.DOM.td null, @props.record.project_name
	...
	render: ->
		if @props.datatype == "medicine_supplier"
			...
			@Customer()
		else if @props.datatype == 'project' or @props.datatype == 'project_mini'
			@Project()
